...
var url = 'http://192.168.50.5:6666'
...
function refreshNodes() {
 ...
 <div id='`+`node.id`+`' class='container movable'>
    ...
    xhttp.send();
    alert("adding behaviors")
    addBehaviors()
    alert("added behaviors")
}
...
for (var i in containers) {
  // containers = containers.concat([$(coll[i].id)])
    ...
    alert("finished very first behavior add")
