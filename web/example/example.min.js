    ...
    function refreshPage() {
        ...
        xhttp.onreadystatechange = function() {
            if (xhttp.readyState == 4) {
                document.getElementById("id01").innerHTML = "Pending Tasks: "+xhttp.responseText;
            }
        };
        ...
        xhttp.onreadystatechange = function() {
            if (xhttp.readyState == 4) {
                ...
                for (i = 0; i < pendingTasks.length; i++) {
                    ...
                    innerHtml += "<div task_info_id="+task.task_id+">Task "+task.name+"<br><code>CPUS:"+task.Cpus+"</code><br><code>MEM:"+task.Mem+"</code><br><code>DISK:"+task.Disk+"</code><br><code>STATUS:TASK_STAGING</code></div>"
                }
...
setInterval(function() {refreshPendingTasks();},1000)

$('state').innerHTML += `
<div id='`+`SOME_ID`+`' class='container movable'>
  <div class='non-movable'><h1>Node 1<br><code>CPUS:0.1</code><br><code>MEM:16</code><br><code>DISK:1</code></h1></div>
  <div>Task 7<br><code>CPUS:0.1</code><br><code>MEM:16</code><br><code>DISK:1</code><br><code>STATUS:TASK_STAGING</code></div>
  <div>Task 8<br><code>CPUS:0.1</code><br><code>MEM:16</code><br><code>DISK:1</code><br><code>STATUS:TASK_STAGING</code></div>
</div>`
// for(var i in coll) {
var containers = []
for (var i in coll) {
