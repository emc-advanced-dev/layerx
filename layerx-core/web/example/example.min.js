            ...
            if (xhttp.readyState == 4) {
                ...
                for (i = 0; i < nodes.length; i++) {
                    ...
                    Object.keys(node.tasks).forEach(function (key) {
                        ...
                        taskJsonDataMap[task.task_id] = task;
                        innerHtml += "<div task_info_id="+task.task_id+" class='clickable movable nodetask'>Task "+task.name+"<br><code>CPUS:"+task.cpus+"</code><br><code>MEM:"+task.mem+"</code><br><code>DISK:"+task.disk+"</code><br><code>from:"+task.task_provider.id+"</code><br><code>STATUS:"+taskStatusJsonDataMap[task.task_id]+"</code></div>"
                    })
                    innerHtml += "</div>"
                    innerHtml += "</div>"
                }
