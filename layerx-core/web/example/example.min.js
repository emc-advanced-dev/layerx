    ...
    xhttp.onreadystatechange = function() {
        if (xhttp.readyState == 4) {
            var innerHtml = `<div class='non-movable'><h3>Pending Tasks</h3></div>`
            ...
            for (i = 0; i < pendingTasks.length; i++) {
                ...
                innerHtml += "<div task_info_id="+task.task_id+" class='clickable movable'>Task "+task.name+"<br><code>CPUS:"+task.cpus+"</code><br><code>MEM:"+task.mem+"</code><br><code>DISK:"+task.disk+"</code><br><code>from:"+task.task_provider.id+"</code><br><code>STATUS: TASK_PENDING</code></div>"
            }
    ...
    function refreshStagingTasks() {
        ...
        xhttp.onreadystatechange = function() {
            if (xhttp.readyState == 4) {
                var innerHtml = `<div class='non-movable'><h3>Staging Tasks</h3></div>`
                var pendingTasksObj = JSON.parse(xhttp.responseText)
                //alert(pendingTasksObj.length+"   " + JSON.stringify(pendingTasksObj[0]))
                var pendingTasks = pendingTasksObj.sort(function(a, b) {
                        return a.task_id.localeCompare(b.task_id);
                ...
                for (i = 0; i < pendingTasks.length; i++) {
                    var task = pendingTasks[i]
                    taskJsonDataMap[task.task_id] = task;
                    innerHtml += "<div task_info_id="+task.task_id+" class='clickable'>Task "+task.name+"<br><code>CPUS:"+task.cpus+"</code><br><code>MEM:"+task.mem+"</code><br><code>DISK:"+task.disk+"</code><br><code>from:"+task.task_provider.id+"</code><br><code>STATUS:"+taskStatusJsonDataMap[task.task_id]+"/code></div>"
                }
                ...
                for (i = 0; i < nodes.length; i++) {
                    ...
                    <div id='`+node.id+`' node_info_id='`+node.id+`' class='container movable node'>
                        <div class='non-movable'>
                            <h3>Node `+i+`<br><code>CPUS:`+cpus+`</code><br><code>MEM:`+mem+`</code><br><code>DISK:`+disk+`</code><br><code>Type:`+resource_type+`</code></h3>
                        </div>`

                    Object.keys(node.tasks).forEach(function (key) {
                        var task = node.tasks[key]
                        taskJsonDataMap[task.task_id] = task;
                        innerHtml += "<div class='task_info'><div task_info_id="+task.task_id+" class='clickable movable nodetask'>Task "+task.name+"<br><code>CPUS: "+task.cpus+"</code><br><code>MEM: "+task.mem+"</code><br><code>DISK: "+task.disk+"</code><br><code>FROM: "+task.task_provider.id+"</code><br><code>STATUS: "+taskStatusJsonDataMap[task.task_id]+"</code></div></div>"
                    })
                    innerHtml += "</div>"
                    innerHtml += "</div>"
                }
    ...
    function clickHandler (e) {
      ...
      target.innerHTML += ' [click!]';
        ...
        $('task-info').innerHTML = "<div><div class='movable'><h3>Task Info</h3></div>"
            +"<div class='task_info'>TASK: "+task.name
            +"<br><code><B>CPUS: </B>"+task.cpus
    ...
    function taskJsonIntoVerboseHtml(taskJson) {
        ...
        innerHtml += "<div>Task "+task.name+
            ...
            "</code><br><code>from:"+task.task_provider.id+
